...
export const comment = (() => {
    ...
    const show = () => {
        ...
        // Guard: If comments element doesn't exist, return resolved promise
        if (!comments) {
            return Promise.resolve({ code: 200, data: { lists: [], count: 0 } });
        }
    ...
    const init = () => {
        ...
        // Guard: If comments element doesn't exist, skip comment initialization
        if (!comments) {
            return;
        }
